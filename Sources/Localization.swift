...
enum Localized {
    ...
    private static let english: [String: String] = [
        ...
        "role.verticalResize": "Vertical",
        "role.horizontalResize": "Horizontal",
        "role.diagonalResizeNWSE": "Diagonal 1",
        "role.diagonalResizeNESW": "Diagonal 2",
    ...
    private static let korean: [String: String] = [
        ...
        "role.person": "사람",
        "role.alternate": "대체",
        "role.verticalResize": "세로",
        "role.horizontalResize": "가로",
        "role.diagonalResizeNWSE": "대각선 1",
        "role.diagonalResizeNESW": "대각선 2",
    ...
    private static let japanese: [String: String] = [
        ...
        "role.person": "人",
        "role.alternate": "代替",
        "role.verticalResize": "縦",
        "role.horizontalResize": "横",
        "role.diagonalResizeNWSE": "斜め 1",
        "role.diagonalResizeNESW": "斜め 2",
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "role.person": "人物",
        "role.alternate": "替代",
        "role.verticalResize": "垂直",
        "role.horizontalResize": "水平",
        "role.diagonalResizeNWSE": "对角线 1",
        "role.diagonalResizeNESW": "对角线 2",
    ...
    private static let traditionalChinese: [String: String] = [
        ...
        "role.verticalResize": "垂直",
        "role.horizontalResize": "水平",
        "role.diagonalResizeNWSE": "對角線 1",
        "role.diagonalResizeNESW": "對角線 2",
    ...
    private static let french: [String: String] = [
        ...
        "role.text": "Texte",
        "role.link": "Lien",
        "role.location": "Épingle",
        "role.precision": "Précision",
        "role.move": "Déplacer",
        ...
        "role.verticalResize": "Vertical",
        "role.horizontalResize": "Horizontal",
        "role.diagonalResizeNWSE": "Diagonale 1",
        "role.diagonalResizeNESW": "Diagonale 2",
    ...
    private static let italian: [String: String] = [
        ...
        "role.person": "Persona",
        "role.alternate": "Alternativo",
        "role.verticalResize": "Verticale",
        "role.horizontalResize": "Orizzontale",
        "role.diagonalResizeNWSE": "Diagonale 1",
        "role.diagonalResizeNESW": "Diagonale 2",
    ...
    private static let russian: [String: String] = [
        ...
        "role.text": "Текст",
        "role.link": "Ссылка",
        "role.location": "Булавка",
        "role.precision": "Точность",
        ...
        "role.verticalResize": "Вертикальный",
        "role.horizontalResize": "Горизонтальный",
        "role.diagonalResizeNWSE": "Диагональ 1",
        "role.diagonalResizeNESW": "Диагональ 2",
