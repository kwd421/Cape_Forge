...
#ifndef CAPE_FORGE_SWIFT_H
#define CAPE_FORGE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Cape_Forge",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
@class NSWindow;
SWIFT_CLASS("_TtC10Cape_Forge24SettingsWindowController")
